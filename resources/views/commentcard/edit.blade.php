            ...
            <div class="col-md-12 col-md-offset-0">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h3>
                            <i class="fa fa-archive"></i>  Editar Pregunta
                            <!--START BUTTON -->
                    ...
                    <div class="box-body">
                        ...
                        {{ Form::model($item, array('route' => array('commentcard.update', $item->id), 'method' => 'PUT')) }}
                            <div class="box-body">
                                <div class="form-group header-group-0 " id="form-group-name">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" maxlength="70" class="form-control" name="pregunta" id="pregunta" value="{{$item->pregunta}}" required>
