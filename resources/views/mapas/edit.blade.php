    ...
    <div>
        ...
        <div class="panel panel-default">
            ...
            <div class="box-body">
                ...
                @endif
                {{ Form::model($item, array('route' => array('mapas.update', $item->id_mapa), 'method' => 'PUT','files' => true)) }}
                <div class="box-body">
                    <div class="form-group header-group-0 " id="form-group-name" style="">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-sm-10">
                                <input type="text" placeholder="Ingrese el nombre" maxlength="70" class="form-control" name="nombre_mapa" id="nombre_mapa" value="{{$item->nombre_mapa}}" required>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-sm-10">
                                <textarea name="descripcion" id="descripcion" rows="10" cols="80"><?php echo $item->descripcion;?></textarea>
                                <div class="text-danger"></div>
                                <p class="help-block"></p>
                            </div>
                        </div>
