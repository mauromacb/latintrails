            ...
            <div class="col-md-12 col-md-offset-0">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h3>
                            <i class="fa fa-archive"></i>  Como nos encontro &nbsp;&nbsp;
                            <!--START BUTTON -->
                    ...
                    <div class="box-body">
                        ...
                        <table id="lista" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            @foreach($items as $k)
                                <tr>
                                    <td><a href="<?php echo $_SERVER['REQUEST_URI'];?>/{{$k->id_como_nos_encontro}}" class="small-box-footer">{{$k->titulo}} <i class="fa fa-arrow-circle-right"></i></a></td>
                                    <td><div class='' style='text-align:right'>
                                            <a class='btn btn-xs btn-primary' title='Ver' href='<?php echo $_SERVER['REQUEST_URI'];?>/{{$k->id_como_nos_encontro}}'> <i class='fa fa-eye'></i></a>
                                            <a class='btn btn-xs btn-success' title='Editar' href='<?php echo $_SERVER['REQUEST_URI'];?>/{{$k->id_como_nos_encontro}}/edit'><i class='fa fa-pencil'></i></a>
                                            <div style='float: right; margin-left: 3px'>
                                            {{ Form::open(['method' => 'DELETE', 'route' => ['categorias.destroy', $k->id_como_nos_encontro]]) }}
