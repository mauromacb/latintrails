...
<?php use App\CalendarioItinerario as calendario;?>
                ...
                <table id="lista" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    @foreach($itinerario as $k)
                        <tr>
                            ...
                            <td>
                                <?php $calendarioItinerario=calendario::where('id_itinerario',$k->id_itinerario)->first();?> <i class="fa fa-calendar-check-o"></i> <strong>{{$calendarioItinerario->fecha_inicio}} - {{$calendarioItinerario->fecha_fin}}</strong>
                            </td>
                            <td>
